...
<html lang="en">
	...
	<body>
        ...
        <section class="bg-cover bg-cover--3" style="background-image: linear-gradient(to bottom, black, transparent), url({{ asset('cors_assets/img/cover-bg-2.jpg') }});">
			<!-- Navbar Start -->
            ...
            <div class="bg-cover-content">
				<h1 class="heading heading--white">Become a trainer</h1>
				<p>{{ become()->banner_desc }}</p>
			</div>
		</section>

		<section class="landing">
			<div class="container">
				<h1 class="heading-sm heading--main mb-3">What is a trainer?</h1>
			...
			<div class="container">
				<div class="row align-items-center">
					<div class="col-lg-6">
						<div class="row align-items-center">
							<div class="col-lg-6">
								<figure class="landing-tiles"><img src="{{ asset('cors_assets/img/landing-avatar.jpg') }}" alt="" /></figure>
							</div>
							<div class="col-lg-6">
								<figure class="landing-tiles mt-70">
									<img src="{{ asset('cors_assets/img/landing-avatar.jpg') }}" alt="" />
								</figure>
							</div>
							<div class="col-lg-6">
								<figure class="landing-tiles"><img src="{{ asset('cors_assets/img/landing-avatar-2.jpg') }}" alt="" /></figure>
							</div>
							<div class="col-lg-6">
								<figure class="landing-tiles"><img src="{{ asset('cors_assets/img/landing-avatar-3.jpg') }}" alt="" /></figure>
							</div>
						</div>
					</div>
					<div class="col-lg-6 text-right">
						<h1 class="heading-sm heading--white mb-5">The team helps you</h1>
						<p class="para-md text-white mb-5">
							Lorem ipsum dolor sit amet, consectetur adipiscing elit. Aenean pretium tellus feugiat
							sagittis semper. Nulla accumsan finibus rutrum. Suspendisse quis luctus tortor.
		...
		<section class="landing">
			<div class="container">
				<h1 class="heading-sm heading--main mb-3">Newly arrived trainer</h1>
				<div class="row">
                    @foreach (trainers()->take(3) as $item)
                    <div class="col-lg-4">
						<div class="landing-social landing-social--1">
							...
							<div class="landing-social-content">
								<h3 class="heading-xs heading-xs--white">{{ ucfirst($item->name) }}</h3>
								<h4 class="text-white mb-3">Trainer</h4>
		...
		<section class="landing">
			<div class="container">
				...
				<a href="{{ route('front.contact') }}" class="button button--outline-main-empty">Consult help</a>
			</div>
		</section>
